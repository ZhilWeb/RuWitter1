...
import { CommentOutlined, HeartFilled, HeartOutlined, EditOutlined, DeleteOutlined } from '@ant-design/icons';
...
const DefaultUserPostItem = (props) => {
...
export default DefaultUserPostItem;