...
namespace RuWitter1.Server.Interfaces
{
    public interface ICommunityInterface
    {
        ...
        Task<string> CreateCommunity(string existingUserId, string name, List<IFormFile> avatars, string briefInformation, int categoryId);
        ...
        Task<IEnumerable<CommunityCategory>> GetCommunitiesCategories();
    }
}
