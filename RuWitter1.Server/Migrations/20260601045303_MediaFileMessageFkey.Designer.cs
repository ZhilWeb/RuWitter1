...
namespace RuWitter1.Server.Migrations
{
    ...
    [Migration("20260601045303_MediaFileMessageFkey")]
    partial class MediaFileMessageFkey
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RuWitter1.Server.Models.CommunityPostsLikes", b =>
                {
                    ...
                    b.HasIndex("DefaultUserId", "CommunityId", "PostId", "CommentId")
                        .IsUnique();
            ...
            modelBuilder.Entity("RuWitter1.Server.Models.PostsLikes", b =>
                {
                    ...
                    b.HasIndex("DefaultUserId", "PostId", "CommentId")
                        .IsUnique();
            ...
            modelBuilder.Entity("RuWitter1.Server.Models.Community", b =>
                {
                    b.HasOne("RuWitter1.Server.Models.MediaFile", "Avatar")
                        .WithOne("Communities")
                        .HasForeignKey("RuWitter1.Server.Models.Community", "AvatarId");
            ...
            modelBuilder.Entity("RuWitter1.Server.Models.DefaultUser", b =>
                {
                    b.HasOne("RuWitter1.Server.Models.MediaFile", "Avatar")
                        .WithOne("User")
                        .HasForeignKey("RuWitter1.Server.Models.DefaultUser", "AvatarId");
            ...
            modelBuilder.Entity("RuWitter1.Server.Models.MediaFile", b =>
                {
                    b.HasOne("RuWitter1.Server.Models.Comment", "Comments")
                        .WithMany("MediaFiles")
                    ...
                    b.HasOne("RuWitter1.Server.Models.Message", "Message")
                        .WithMany("MediaFiles")
                        .HasForeignKey("MessageId");

                    b.HasOne("RuWitter1.Server.Models.Post", "Posts")
                        .WithMany("MediaFiles")
