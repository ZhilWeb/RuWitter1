    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommunityCategory", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PermittedMediaTypeId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BriefInformation = table.Column<string>(type: "character varying(10000)", maxLength: 10000, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultUserId1 = table.Column<string>(type: "text", nullable: true),
                    Name = table.Column<string>(type: "character varying(150)", maxLength: 150, nullable: false),
                    AvatarId = table.Column<int>(type: "integer", nullable: true),
                    BriefInformation = table.Column<string>(type: "character varying(10000)", maxLength: 10000, nullable: false),
                    CommunityCategoryId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.DefaultUserId1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Community_CommunityCategory_CommunityCategoryId",
                        column: x => x.CommunityCategoryId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommunityPostWatches", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CommunityPostWatches_Posts_PostId",
                        column: x => x.PostId,
                        principalTable: "Posts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommunityPostsLikes", x => x.Id);
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CommunityPostsLikes_Posts_PostId",
                        column: x => x.PostId,
                        principalTable: "Posts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommunityPostsLikes_CommentId",
                table: "CommunityPostsLikes",
                column: "CommentId");

            migrationBuilder.CreateIndex(
                name: "IX_CommunityPostsLikes_CommunityId",
                table: "CommunityPostsLikes",
                column: "CommunityId");

            migrationBuilder.CreateIndex(
                name: "IX_CommunityPostsLikes_PostId",
                table: "CommunityPostsLikes",
                column: "PostId");

            migrationBuilder.CreateIndex(
                name: "IX_CommunityPostWatches_CommunityId",
                table: "CommunityPostWatches",
                column: "CommunityId");

            migrationBuilder.CreateIndex(
                name: "IX_CommunityPostWatches_PostId",
                table: "CommunityPostWatches",
                column: "PostId");
